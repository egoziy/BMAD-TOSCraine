...
namespace RTGApp
{
    public partial class frmInformation : Form
    {
        ...
        private void frmInformation_Load(object sender, EventArgs e)
        {
           ...
           string SqlStr="";
            ...
            if (FromLocationString != "")
            {
             ...
             this.dataGridContaunersInList.DataSource = Con3.ReturnDT("SELECT  מכולה, גודל, סוג, משקל, קוד, קו, משאית, איתור, המתנה, UN, AVDM, EntranceDriverID FROM   dbo.V_ContainerUnloadRTG3 ORDER BY מכולה");

            // טעינה

             this.dataGridContaunersOutList.DataSource = Con3.ReturnDT("SELECT    מכולה, גודל, סוג, משקל, קוד, קו, משאית, איתור, מיקום, המתנה, UN, AVDM, ExitDriverID , Type   FROM V_RTG3Load ORDER BY המתנה DESC");
            ...
            {
                ContainerLocation.WriteLog("Error in form2 frmInformation_Load : " + ex);
            }
        ...
        private void BtmRTG_Click(object sender, EventArgs e)
        {
            ...
            {
                ContainerLocation.WriteLog("Error in form2 dataGridContaunersOutList_CellClick : " + ex);
            }
