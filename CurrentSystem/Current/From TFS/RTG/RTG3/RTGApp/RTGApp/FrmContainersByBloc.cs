...
namespace RTGApp
{
    public partial class FrmContainersByBloc : Form
    {
        ...
        public FrmContainersByBloc()
        {
            ...
            {
                ContainerLocation.WriteLog("Error in FrmContainersByBloc FrmContainersByBloc : " + ex);
            }
}
        ...
        private void cmbLoction_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                ContainerLocation.WriteLog("Error in FrmContainersByBloc cmbLoction_SelectedIndexChanged : " + ex);
            }
        }
        ...
        private void cmbHazardousSubstances_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                ContainerLocation.WriteLog("Error in FrmContainersByBloc cmbHazardousSubstances_SelectedIndexChanged : " + ex);
            }
