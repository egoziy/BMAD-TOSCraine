...
namespace RTGApp
{
    public partial class FrmExpectedContainers : Form
    {
        ...
        public FrmExpectedContainers()
        {
            ...
            {
                ContainerLocation.WriteLog("Error in FrmExpectedContainers FrmExpectedContainers : " + ex);
            }
        }
        ...
        protected void GetFilter()
        {
            ...
            {
                ContainerLocation.WriteLog("Error in FrmExpectedContainers GetFilter : " + ex);
            }
        }
