...
namespace RTGApp
{
    public partial class FrmRecommendedLocation : Form
    {
        ...
        public FrmRecommendedLocation()
        {
            ...
            {
                ContainerLocation.WriteLog("Error in FrmRecommendedLocation FrmRecommendedLocation : " + ex);
            }
        }
        ...
        private void cmbClientCode_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                ContainerLocation.WriteLog("Error in FrmRecommendedLocation cmbClientCode_SelectedIndexChanged : " + ex);
            }
        }
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            {
                ContainerLocation.WriteLog("Error in FrmRecommendedLocation btnOK_Click : " + ex);
            }
        }
